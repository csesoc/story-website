...
from common.database import addCompetition, addReplica, addSolve, addUser, add_user_with_uid
...
#     add_user_with_uid(27, "asdfghjkl@gmail.com", "asdf", "foobar")
...
#     assert response.status_code == 200
#     print(response.json['leaderboard'])
